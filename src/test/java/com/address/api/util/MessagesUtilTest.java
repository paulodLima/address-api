...
class MessagesUtilTest {
    ...
    void getMessageWithResolvable() {
        ...
        FieldError fieldError = new FieldError("AddressDTO", "state", MessagesUtil.getMessage("javax.validation.constraints.NotBlank.message", "state"));

        assertEquals("state no puede ser vazio", MessagesUtil.getMessage(fieldError));
